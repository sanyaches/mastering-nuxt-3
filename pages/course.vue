<template>
  ...
  <div class="flex flex-row justify-center flex-grow">
    <div
      class="prose overflow-y-auto max-h-fit mr-4 p-8 bg-white rounded-md min-w-[20ch] max-w-[30ch] flex flex-col"
    >
      <h3>Chapters</h3>
      <div
    ...
    <div class="prose p-12 bg-white rounded-md w-[65ch]">
      <NuxtErrorBoundary>
        ...
        <template #error="{ error }">
          <p>Something went wrong with displaying of the lesson: <code>{{ error }}</code></p>
